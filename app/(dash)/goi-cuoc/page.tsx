...
export default function GoiCuocPage() {
    ...
    <div className="pricing-container">
      ...
      <section className="current-plan-card" aria-label="Tình trạng gói hiện tại">
        <div className="current-plan-card__info">
          ...
          <div>
            <h2 className="current-plan-card__title">Gói Dùng thử (Trial Plan)</h2>
            <p className="current-plan-card__sub">
              Thời hạn còn <strong>5 ngày</strong> · Không gian làm việc: <strong>SANG 5M STUDIO</strong>
            </p>
          </div>
        </div>
        ...
        <div className="current-plan-card__stats">
          <div className="plan-stat">
            <div className="plan-stat__label">Tín dụng đã dùng</div>
            <div className="plan-stat__val">1.240 / 3.000</div>
          </div>
          <div className="plan-stat">
