      ...
      <div className="lp__inner">
        ...
        <section className="hero">
          ...
          <div className="hero__cta">
            ...
            <Link className="hero__btn hero__btn--ghost" href="/goi-cuoc">
        ...
        <section className="cta-banner">
          ...
          <a className="hero__btn hero__btn--primary" href="/api/dev-login" style={{ padding: '16px 36px', fontSize: '16px' }}>
            🚀 Trải nghiệm Demo ngay bây giờ →
          </a>
        </section>
