...
const LOI_NHAC = {
  ...
  'de-xuat-y-tuong': {
    ...
    loiNhac: [
      ...
      'Chi duoc su dung "trendSignalId" xuat hien trong danh sach "mauNgoai" duoc cung cap.',

      'Neu y tuong khong su dung tin hieu xu huong, dat "trendSignalId" la null.',

      'KHONG BAO GIO tu tao, sua, doan hoặc suy ra mot trendSignalId khong co trong "mauNgoai".',
