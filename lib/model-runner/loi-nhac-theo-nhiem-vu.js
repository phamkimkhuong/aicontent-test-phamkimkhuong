...
const CHUNG = [
  ...
  'BAT BUOC viet tieng Viet CO DAU day du, chuan chinh ta, giong tu nhien, khong dung tu sao rong (TUYET DOI khong viet tieng Viet khong dau).',
].join('\n');
...
const LOI_NHAC = {
  ...
  'viet-bai': {
    ...
    loiNhac: [
      'Viet bai dang mang xa hoi hoan chinh dua tren y tuong, goc tiep can va du lieu thuong hieu duoc cung cap.',
      'Bai viet phai giu dung giong thuong hieu va dac trung cua be mat dang duoc yeu cau.',
      'Neu du lieu vao co truong "epDoDai": do la rang buoc so tu BAT BUOC cua lan viet nay, phai dem tu va viet dung so tu do.',
      'Neu du lieu vao co truong "mach": do la cac bai truoc trong cung mot chuoi, bai nay phai noi tiep mach ke chuyen, phat trien y tiep theo va TUYET DOI khong lap lai cac y da noi o bai truoc.',
      'Kem theo 3-5 hashtag ngan phu hop nganh hang o truong "hashtag".',
      CHUNG,
  ...
  'viet-kich-ban': {
    ...
    loiNhac: [
      'Viet kich ban quay video ngan (TikTok / Reels / Shorts / Fanpage Video) theo cau truc phan canh chi tiet (Storyboard).',
      'Moi phan canh la mot hanh dong quay hoac mot shot hinh rieng biet, gom:',
      '- "thoiLuongGiay": Thoi luong uoc tinh (so nguyen giay tu 2 den 8 giay). Tong thoi luong ca video nen trong khoang 20-60 giay.',
      '- "hinhAnh": Mo ta ro rang goc may (can canh, trung canh, goc nhin thu nhat POV...), hanh dong dien xuat, boi canh, dao cu hoac text overlay hien tren man hinh.',
      '- "loiThoai": Loi thoai noi truc tiep cua nhan vat hoac giong doc Voiceover. Cau ngan gon, tu nhien, doc vua van voi so giay quy dinh.',
      'Cau truc video giu chan nguoi xem bat buoc:',
      '1. Canh 1 (Hook 1-3 giay dau): Visual an tuong + Cau hook danh trung noi dau/su to mo. TUYET DOI khong chao hoi hay gioi thieu.',
      '2. Canh 2 (Van de/Ngu canh): Dien ta noi dau cua khach hang hoac tinh huong thuc te.',
      '3. Canh 3-4 (Giai phap/Demo thuc te): Trinh dien san pham/giai phap mot cach thuc te, khong than thanh hoa.',
      '4. Canh cuoi (Loi keu goi - CTA): 1 loi keu goi duy nhat (luu lai, thu ngay, binh luan...).',
      'Phai bam sat giong thuong hieu va tuan thu danh sach tu cam ky duoc truyen vao.',
      CHUNG,
  ...
  'de-xuat-y-tuong': {
    ...
    loiNhac: [
      'De xuat y tuong noi dung mang xa hoi hang ngay cho chu shop dua tren du lieu ho so thuong hieu duoc cung cap.',

      'QUOTA TRU COT: Du lieu "phanBoTruCot" la quota bat buoc cho lan sinh nay. Hay tao dung so luong candidate cho tung tru cot theo quota. Khong tu thay doi quota. Khong tao tru cot moi.',

      'Moi y tuong PHAI NEO vao mot "truCot" va mot "chanDung" CO THAT trong danh sach tru cot va chan dung cua nguoi dung.',

      'TUYET DOI khong tu bia ra ten tru cot hoac chan dung moi khong co trong danh sach.',

      'QUOTA KHAM PHA: Uu tien tao khoang "soLuongKhamPhaMucTieu" y tuong co "kham_pha": true de do duong, thu nghiem goc nhin moi hoac tuyen noi dung it du lieu. Thuoc tinh "kham_pha" phai phan anh dung ban chat y tuong, khong danh dau chi de du quota.',

      'Cac y tuong con lai "kham_pha": false tap trung vao cac tuyen chu luc, insight va noi dau sau sac cua khach hang.',

      'Moi y tuong phai co tieuDe ro rang, gocTiepCan thuc te, cauMoDau (hook) hap dan dung beMat yeu cau, va lyDoDeXuat ngan gon thuyet phuc.',

      'Sinh dung soLuong y tuong va dung beMat duoc yeu cau trong du lieu.',

      'Neu y tuong duoc lay cam hung tu mot tin hieu xu huong trong "mauNgoai", truong "trendSignalId" PHAI bang chinh "id" cua tin hieu do.',

      'Chi duoc su dung "trendSignalId" xuat hien trong "mauNgoai".',

      'Neu y tuong khong dung tin hieu xu huong, "trendSignalId" la null.',

      'KHONG BAO GIO dua nguyen van noi dung bai tham khao vao y tuong. Chi hoc chu de va cong thuc ke tu "mauNgoai".',
