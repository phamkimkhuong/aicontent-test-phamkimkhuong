...
const LOI_NHAC = {
  ...
  'de-xuat-y-tuong': {
    ...
    loiNhac: [
      ...
      'Neu y tuong duoc lay cam hung tu mot tin hieu xu huong trong "mauNgoai", truong "nguonThamKhao" phai la dung gia tri "soThuTu" cua tin hieu do.',

      'Chi duoc dung soThuTu xuat hien trong "mauNgoai".',

      'Neu y tuong khong dua tren tin hieu xu huong, "nguonThamKhao" la null.',

      'Tuyet doi khong tu tao soThuTu moi.',
