...
const KHOI_Y_TUONG_TU_XU_HUONG = [
  '',
  'THAM KHAO CONG THUC KE TU KENH NGOAI (neu co trong du lieu "mauNgoai"):',
  '- Chi duoc hoc CHU DE va CONG THUC KE cua bai tham khao.',
  '- Khong sao chep noi dung, cau van, caption, cach dien dat hoac giong viet cua bai tham khao.',
  '- Giong viet cua y tuong PHAI theo ho so thuong hieu cua workspace hien tai.',
  '- Neu y tuong duoc lay cam hung tu mot tin hieu xu huong, gan "trendSignalId" bang DUNG ID cua tin hieu do trong "mauNgoai".',
  '- Chi duoc su dung ID xuat hien trong "mauNgoai". Khong tu tao ID moi.',
  '- Neu y tuong khong dua tren tin hieu xu huong, "trendSignalId" phai la null.',
  '- "trendSignalId" chi la thong tin provenance cua nguon tham khao, khong phai noi dung de sao chep.',
].join('\n');
