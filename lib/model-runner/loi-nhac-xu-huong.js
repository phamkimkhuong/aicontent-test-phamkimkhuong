...
const KHOI_Y_TUONG_TU_XU_HUONG = [
  ...
  '- Hoc CONG THUC KE (kieuHook) va CHU DE de ap dung vao san pham va thuong hieu cua shop.',
  '- TUYET DOI KHONG chep van phong bai ngoai. Giong ke phai la giong thuong hieu trong ho so.',
  '- Y tuong lay cam hung tu tham khao can neu ro ly do va goc tiep can phu hop voi chu shop.',
  '- NEU y tuong duoc goi y boi mot bai trong mauNgoai, PHAI gan truong "trendSignalId" bang',
  '  chinh "id" cua bai mauNgoai do. Chi gan id CO THAT trong mauNgoai, KHONG tu bia.',
  '- Y tuong KHONG lien quan den mauNgoai thi BO TRONG "trendSignalId" (khong phai null, ma khong co truong).',
].join('\n');
